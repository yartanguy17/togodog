                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            <div class="product product-single">
                                <div class="product-thumb">
                                    ...
                                    <img src="{{ asset('website/assets/img/product/f1.jpeg') }}" alt="">
                                </div>
                                <div class="product-body">
                                    ...
                                    <h2 class="product-name"><a href="#">Farine 009</a></h2>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            <div class="product product-single">
                                <div class="product-thumb">
                                    <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                    <img src="{{ asset('website/assets/img/product/f2.jpeg') }}" alt="">
                                </div>
                                <div class="product-body">
                                    ...
                                    <h2 class="product-name"><a href="#">Farine 008</a></h2>
                                    <div class="product-btns">
                                        <button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
                                        <button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
                                        <button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            <div class="product product-single">
                                <div class="product-thumb">
                                    ...
                                    <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                    <img src="{{ asset('website/assets/img/product/f3.jpeg') }}" alt="" style="height: 220px;">
                                </div>
                                <div class="product-body">
                                    {{-- <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3> --}}
                                    <div class="product-rating">
                                    ...
                                    <h2 class="product-name"><a href="#">Farine 004</a></h2>
                                    <div class="product-btns">
                                        <button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
                                        <button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
                                        <button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
